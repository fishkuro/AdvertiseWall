...
typedef enum{
    ZhiMengIpointSize300x250 = 0,   //iphone and ipod touch ad size
    ZhiMengIpointSize680x567 = 1,    //ipad ad size
}ZhiMengIpointSize;

@interface ZhiMengIpoint : NSObject

//是否正在运行
@property (nonatomic,readonly)BOOL    running;

//使用单例类，方便在全局控制
+ (ZhiMengIpoint *)requestIpWithSize:(ZhiMengIpointSize)size;
/*
 i悠广告显示的方法
   eg：  
            ZhiMengIpoint *zhimengIpoint =  [ZhiMengIpoint requestIad];
            [zhimengIpoint startRunning];
 */
- (void)startRunning;
/*
